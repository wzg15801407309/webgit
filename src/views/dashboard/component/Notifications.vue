              ...
              <v-col cols="10" lg="8">
                <v-row>
                  <v-col v-for="dir in directions" :key="dir" cols="4">
                    <v-btn color="secondary" default class="v-btn--block" @click="randomColor(), direction = dir, snackbar = true">
                      {{ dir }}
                    </v-btn>
                  </v-col>
                </v-row>
    ...
    <v-dialog v-model="dialog" max-width="500">
      <v-card class="text-center">
        ...
        <v-card-text>
          ...
          necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth. Even the all-powerful Pointing has no control about the blind texts it is an almost unorthographic life One day however a small line of blind text by the name of Lorem Ipsum
        ...
        <v-card-text class="body-1 text-center">
          <v-row>
            ...
            <v-col class="hidden-sm-and-down" md="4">
              <v-sheet>
                <v-img src="https://demos.creative-tim.com/material-dashboard/assets/img/card-1.jpg" height="100" width="200" />
              </v-sheet>
            </v-col>
            ...
            <v-col class="hidden-sm-and-down" md="4">
              <v-sheet>
                <v-img src="https://demos.creative-tim.com/material-dashboard/assets/img/card-2.jpg" height="100" width="200" />
              </v-sheet>
            </v-col>
