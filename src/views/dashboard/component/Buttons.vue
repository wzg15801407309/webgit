      ...
      <v-card-text class="pt-0">
        <v-row>
          <v-col cols="12" md="6">
            ...
            <div>
              <v-btn v-for="(color, i) in colors" :key="i" elevation="1" :color="color === 'default' ? undefined : color" class="ma-1">
                {{ color }}
              </v-btn>
            </div>
          </v-col>
          <v-col class="pt-0" cols="12" md="6">
            ...
            <div>
              <v-btn v-for="(dir, i) in ['left', 'right']" :key="i" elevation="1" class="ma-1">
                <v-icon :left="dir === 'left'" :right="dir === 'right'" :class="dir === 'right' && 'order-last'" v-text="icons[dir]" />
                {{ dir }}
              </v-btn>
              <v-btn v-for="(color, i) in colors.slice(2)" :key="`btn-${i}`" elevation="1" :color="color === 'default' ? undefined : color" class="ma-1">
          ...
          <v-col cols="12" md="6">
            ...
            <v-btn v-for="n in 3" :key="n" elevation="1" :small="n === 1" :large="n === 3" class="ma-1" color="secondary">
          ...
          <v-col cols="12" md="6">
            ...
            <v-pagination :length="3" :value="2" circle class="justify-start" next-icon="mdi-menu-right" prev-icon="mdi-menu-left" />
          </v-col>
